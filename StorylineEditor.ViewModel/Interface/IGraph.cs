...
namespace StorylineEditor.ViewModel.Interface
{
    ...
    public interface IGraph
    {
        ...
        void MoveTo(IPositioned positioned, Action<TaskStatusCustom> callbackAction, float playRate);
        void MoveTo(string positionedId, Action<TaskStatusCustom> callbackAction, float playRate);
